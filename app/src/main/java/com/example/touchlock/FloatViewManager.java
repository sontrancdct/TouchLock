...
public class FloatViewManager  {
   ...
   public FloatViewManager(Activity activity){
      ...
      mFloatViewLayoutParams.gravity = Gravity.TOP;
      ...
      final ImageButton imageButton = mFloatView.findViewById(R.id.imageButton);

//      imageButton.setOnLongClickListener(new View.OnLongClickListener() {
//         @Override
//         public boolean onLongClick(View v) {
//            Toast.makeText(mActivity, "long click", Toast.LENGTH_SHORT).show();
//            mFloatViewLayoutParams.width = WindowManager.LayoutParams.MATCH_PARENT;
//            mFloatViewLayoutParams.height = WindowManager.LayoutParams.MATCH_PARENT;
//            return false;
//         }
//      });
...
//               mFloatViewFirstY = mFloatViewLastY;
               ...
               case MotionEvent.ACTION_UP:
                  ...
                  if(clickCount == 2)
                  {
                     ...
                     {
                         dismissFloatView();
                        Toast.makeText(mActivity, "Thoát khóa.",Toast.LENGTH_LONG).show();
                     }
                     clickCount = 0;
                     duration = 0;
                     break;
   ...
   private View.OnClickListener mFloatViewOnClickListener = new View.OnClickListener() {
      ...
      public void onClick(View v) {
         mActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
               Toast.makeText(mActivity, "Floating view", Toast.LENGTH_SHORT).show();
            }
         });
      }
   };
               ...
               if(clickCount == 2)
               {
                  if(duration<= MAX_DURATION)
                  {
                    // mFloatViewLayoutParams.gravity = Gravity.CENTER;
                     mFloatViewLayoutParams.width = WindowManager.LayoutParams.MATCH_PARENT;
                     mFloatViewLayoutParams.height = WindowManager.LayoutParams.MATCH_PARENT;
                     Toast.makeText(mActivity, "double tap",Toast.LENGTH_LONG).show();
                  }
                  clickCount = 0;
                  duration = 0;
                  break;
